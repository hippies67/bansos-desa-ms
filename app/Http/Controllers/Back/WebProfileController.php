...
class WebProfileController extends Controller
{
    ...
    {
        $data['web'] = WebProfile::all();
        return view('back.web_profile.index', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = [
            ...
            'dark_primary_color' => $request->edit_dark_primary_color ? $request->edit_dark_primary_color : $web->dark_primary_color,
            'light_primary_color' => $request->edit_light_primary_color ? $request->edit_light_primary_color : $web->light_primary_color,
