...
<section class="section">
    <div class="section-header">
        <div class="page-titles">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Web Profile</a></li>
                <li class="breadcrumb-item active"><a href="{{ route('web-profile.index') }}">Data Web Profile</a></li>
            </ol>
        </div>
    </div>
                        ...
                        <form action="{{ route('web-profile.update', $webs->id) }}" method="POST" id="editWebForm"
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <input type="text" id="primary-color" name="edit_primary_color"
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="text" id="dark-primary-color" name="edit_dark_primary_color"
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="text" id="light-primary-color" name="edit_light_primary_color"
                                        class="form-control text-dark" value="{{ $webs->light_primary_color }}"
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-danger text-white"
                                                id="inputGroupPrepend3"><i class="fa fa-envelope"></i> </span>
                                        </div>
                                    ...
                                    <small>mailto:<b
                                            id="emailUsername">{{old('edit_email') ?? $webs->email}}</b></small>
                                    <br>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text text-white"
                                                style="background-color: rgb(79, 29, 242)" id="inputGroupPrepend3"><i
                                                    class="fas fa-tags"></i></span>
                                        </div>
                                        <input type="text" id="tagline" name="edit_tagline"
                                            value="{{old('edit_tagline') ?? $webs->tagline}}"
                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text text-white"
                                                style="background-color: rgb(38, 40, 41)" id="inputGroupPrepend3"><i
                                                    class="fas fa-phone"></i></span>
                                        </div>
                                        <input type="text" id="edit_phone" name="edit_phone"
                                            value="{{old('edit_phone') ?? $webs->phone}}" class="form-control text-dark"
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text text-white"
                                                style="background-color: rgb(235, 196, 21)" id="inputGroupPrepend3"><i
                                                    class="far fa-id-card"></i></span>
                                        </div>
                                        <input type="text" id="edit_name" name="edit_name"
                                            value="{{old('edit_name') ?? $webs->name}}" class="form-control text-dark"
                                            placeholder="Nama">
                                    </div>
                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text text-white"
                                                style="background-color: rgb(225,48,108)" id="inputGroupPrepend3"><i
                                                    class="fab fa-instagram"></i></span>
                                        </div>
                                        <input type="text" id="instagram" onkeyup="keyup('instagram')"
                                            name="edit_instagram" value="{{old('edit_instagram') ?? $webs->instagram}}"
                                            class="form-control text-dark" placeholder="Username instagram">
                                    </div>
                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="facebook" onkeyup="keyup('facebook')"
                                            name="edit_facebook" class="form-control text-dark"
                                            value="{{old('edit_facebook') ?? $webs->facebook}}"
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="twitter" onkeyup="keyup('twitter')" name="edit_twitter"
                                            ...
                                            value="{{old('edit_twitter') ?? $webs->twitter}}"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="whatsapp" onkeyup="keyup('whatsapp')"
                                            name="edit_whatsapp" class="form-control text-dark"
                                            value="{{old('edit_whatsapp') ?? $webs->whatsapp}}"
                                            placeholder="Ganti awalan 0 dengan 62">
                                    </div>
                                    <small>https://wa.me/<b
                                            id="whatsappUsername">{{old('edit_whatsapp') ?? $webs->whatsapp}}</b></small>
                                </div>
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="youtube" onkeyup="keyup('youtube')" name="edit_youtube"
                                            class="form-control text-dark"
                                            value="{{old('edit_youtube') ?? $webs->youtube}}"
                      ...
                      Storage::exists($webs->logo)){{ Storage::url($webs->logo) }}@endif">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <label for="description" generated="true" class="error"
                                        style="display: none;"></label>
                                </div>
                            </div>
                            <br>
                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" id="email" onkeyup="keyup('email')" name="email"
                                            class="form-control text-dark" value="{{old('email')}}"
                                            placeholder="Alamat email">
                                    </div>
                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="instagram" onkeyup="keyup('instagram')" name="instagram"
                                            value="{{old('instagram')}}" class="form-control text-dark"
                                            placeholder="Username instagram">
                                    </div>
                                    <small>https://instagram.com/<b
                                            id="instagramUsername">{{old('instagram')}}</b></small>
                                </div>
                                <div class="col-sm">
                                    <label for="facebook">Facebook</label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="facebook" onkeyup="keyup('facebook')" name="facebook"
                                            class="form-control text-dark" value="{{old('facebook') }}"
                                            placeholder="Username facebook">
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="twitter" onkeyup="keyup('twitter')" name="twitter"
                                            class="form-control text-dark" value="{{old('twitter')}}"
                                            placeholder="Username twitter">
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="whatsapp" onkeyup="keyup('whatsapp')" name="whatsapp"
                                            class="form-control text-dark" value="{{old('whatsapp')}}"
                                            placeholder="Ganti awalan 0 dengan 62">
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="youtube" onkeyup="keyup('youtube')" name="youtube"
                                            class="form-control text-dark" value="{{old('youtube')}}"
                                            placeholder="Username Youtube">
                                    </div>
...
<script>
    $('#primary-color, #dark-primary-color, #light-primary-color').spectrum({
        type: "component"
    });
    $('.dropify').dropify();
