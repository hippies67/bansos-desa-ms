            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="button-list">
                        ...
                        class="btn btn-primary btn-xs text-white"><i class="fa fa-plus-circle mr-1"></i> Tambah</button>
                ...
                <div wire:ignore>
                    <table id="userTable" class="table dt-responsive" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Nama</th>
                                ...
                                <td>
                                    ...
                                    <div class="form-group" style="display: block;">
                                        <button type="button" data-toggle="modal" data-target="#editUserModal"
                                            style="padding-bottom:2px;" data-ids="{{ $user->id }}"
                                            onclick="setEditData({{ $user }})" class="btn btn-warning btn-xs text-white"><i
                    ...
                    <form wire:submit.prevent="userStore">
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 @error('nama_lengkap') is-invalid @enderror" type="text"
                                    wire:model.debounce.500ms="nama_lengkap" placeholder="Masukan Nama Lengkap"
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 @error('email') is-invalid @enderror" 
                                type="email" placeholder="Masukan Email Anda" wire:model.debounce.500ms="email"
                                    value="{{ old('email') }}">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group mb-1">
                                    <input class="form-control @error('password') is-invalid @enderror" type="password"
                                        wire:model.debounce.500ms="password" placeholder="Masukan Password Anda">
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <div class="input-group mb-1">
                                    <input class="form-control @error('password_confirmation') is-invalid @enderror" type="password" wire:model.debounce.500ms="password_confirmation" placeholder="Masukan Konfirmasi Password Anda"
                                        value="{{ old('email') }}">
                                    <div class="input-group-append">
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 @error('no_telp') is-invalid @enderror" type="number"
                                    wire:model.debounce.500ms="no_telp" placeholder="Masukan Nomor Hp Anda"
                                    value="{{ old('no_telp') }}">
                                @error('no_telp')
                                    <div class="mt-1">
                                        <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 @error('alamat') is-invalid @enderror" type="text"
                                    wire:model.debounce.500ms="alamat" placeholder="Masukan Alamat Anda" value="{{ old('alamat') }}">
                                @error('alamat')
                                    <div class="mt-1">
                                        <span class="text-danger">{{ $message }}</span>
                                    </div>
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 @error('tgl_lahir') is-invalid @enderror" type="date"
                                    wire:model.debounce.500ms="tgl_lahir" placeholder="Masukan Tanggal Lahir"
                                    value="{{ old('tgl_lahir') }}">
                                @error('tgl_lahir')
                                    <div class="mt-1">
                                        <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <select wire:model.debounce.500ms="jenis_kelamin" class="form-control form-control-lg">
